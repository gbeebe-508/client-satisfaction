...
ggpairs(subset(survey_data, select = c("question1", "question2", "question3", "question4", "question5")))

test <- na.omit(subset(survey_data, select = c("question1", "question2", "question3", "question4", "question5")))
rename(test, c("Q1" = "question1", "Q2" = "question2", "Q3" = "question3", "Q4" = "question4", "Q5" = "question5"))

ggpairs(test, lower = list(continuous = wrap("smooth", alpha = 0.3, size=0.1)), progress = FALSE)
